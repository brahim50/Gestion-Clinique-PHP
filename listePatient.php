...
<table class="table" style="margin-left: 210px;margin-top: 50px; ">
                ...
                $query ="SELECT *FROM medecin,patient,rendezvous WHERE medecin.id='$ide' AND medecin.id=rendezvous.idMedecin AND rendezvous.idPatient=patient.idP";
               ...
               while($row = $res->fetch_assoc()){
                ...
                <td><?php echo $row['emailPatient'];?></td>
